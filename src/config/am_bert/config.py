...
# use smaller dev set
_C.LOADER.SMALL_DEV = 1000  # None
# use balanced version
_C.LOADER.BALANCED = False
# discretize labels
_C.LOADER.DISCRETIZER = "equal_width"
# start and end for discretization
_C.LOADER.START_END = (-5, 5)  # -> number of bins are defined in "NUM_LABELS"
